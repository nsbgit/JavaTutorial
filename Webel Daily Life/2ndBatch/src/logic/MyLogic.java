...
public class MyLogic {
	...
	public int insert(String name, String address, String gender, String standard) {
		Connection con=null;
		try {
			//Class.forName("com.mysql.jdbc.Driver");// "Driver name"
	...
	public ArrayList getRecords() {
		...
		try {
			...
			String sql = "SELECT name, address, standard, gender FROM student";// Select attributes from table student
