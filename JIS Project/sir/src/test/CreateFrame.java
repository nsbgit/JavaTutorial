...
public class CreateFrame extends JFrame implements ActionListener {
	private JLabel l0,l01,l1,l2,l3,l4,l40,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l16,l17,l18,l19,l20;
	private JTextField t1,tid1,tid2,tid3,tid4,tid5,tid6,tid7,tid8,tid10;
	private JComboBox city,day,month,year,annualincome,identity,profession,acno;
		    					    				 ...
		    					    				 if(count > 0) {
		    					    					 ...
		    					    					 if(Integer.parseInt(ini) >= 500) {
		    						    					...
		    						    					if(con==JOptionPane.YES_OPTION) {
		    						    						...
		    						    						new Actotalcreate(Integer.parseInt(t1.getText()),0,Integer.parseInt(tid10.getText()),Integer.parseInt(tid10.getText()));
