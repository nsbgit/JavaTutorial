...
<div id="container">
  		<div id="header">
  			...
  			<div id="menuBar"><div id='cssmenu'>
				<ul>
     			...
     			<ul>
         			<li><a href='../mainToAdminSection/adminSignUp.jsp'><span>Organisation SignUp</span></a></li>
         			<li class='last'><a href='../mainToVoterSection/voterSignUp.jsp'><span>Voter SignUp</span></a></li>
      			</ul>
   			</li>
  			...
  			<div id="menuBar"><div id='cssmenu'>
  				<ul>
  					...
  					<ul>
  						...
  						<li><a href="../adminSection/forgottenPassword.jsp"><span>Forgot Password</span></a></li>
  		...
  		<div>
			...
			<form action="<%= request.getContextPath() %>/SAdmin.do?linkId=2" method="post" style="padding-top: 99px;">
