...
<link rel="stylesheet" href="../css/voter_sign_up.css" type="text/css" />
...
<div id="container">
	...
	<div>
		...
		<form action="<%= request.getContextPath() %>/SVoterSignUp.do" method="post" enctype="multipart/form-data" style="padding-top: 9px;">
