...
class RegistrationFrame extends JFrame implements ActionListener
{
	...
	private JButton bsubmit,bshow, bsearch, bupdate;
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource() == bsubmit)
		{
			...
			{
			   new AddInformation(reg);//calling the constructor for add information into the array list and passing the object
			}
