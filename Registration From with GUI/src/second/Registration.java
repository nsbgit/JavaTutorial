...
class RegistrationFrame extends JFrame implements ActionListener
{
	...
	public RegistrationFrame(String title)//constructor
	{
		 ...
		 * 2. Here we have to pass the object of the class as argument, as it is in same class
		 *    we are using this.
		 * */
	...
	@Override
	public void actionPerformed(ActionEvent arg0)//arg0 is reference
	/* As the mouse click occurred a object is created and passes to this arg0 becomes a object form refernce
	 * */
	{
		//JOptionPane.showMessageDialog(this, "Mouse click occurred");//to print message dialog box and this is catching the passing object from addActionListner
		if(arg0.getSource() == bsubmit)//identify the click is occurred on which button
		{
