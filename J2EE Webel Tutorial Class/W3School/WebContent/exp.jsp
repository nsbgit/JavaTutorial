...
<div class="formnames">City: </div><input type="text" class="input" maxlength="20" name="city"  value='' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <select name="state"><option  value="">--Select--</option>
		...
		<option value="Andaman And Nikobar Island" >Andaman And Nikobar Island </option>
...
<div class="porgramselection">
		 		            ...
		 		            <input type="radio" onclick="showcoursedetails('getdetails');" id="sc0" name="selectcourse"   value="8, Mobile Application development in Android ,Kolkata"  />&nbsp;<label for="sc0>" onclick="showcoursedetails('getdetails');"> Mobile Application development in Android </label><br /> 
		 		 
		 		 
		 		            <input type="radio" onclick="showcoursedetails('getdetails');" id="sc1" name="selectcourse"   value="3, Application Development using Java 7,Kolkata"  />&nbsp;<label for="sc1>" onclick="showcoursedetails('getdetails');"> Application Development using Java 7</label><br /> 
		 		 
		 		 
		 		            <input type="radio" onclick="showcoursedetails('getdetails');" id="sc2" name="selectcourse"   value="1, Web Based Enterprise Application Development using JEE 6,Kolkata"  />&nbsp;<label for="sc2>" onclick="showcoursedetails('getdetails');"> Web Based Enterprise Application Development using JEE 6</label><br /> 
		 		 
		 		 
		 		            <input type="radio" onclick="showcoursedetails('getdetails');" id="sc3" name="selectcourse"   value="6, Programming with PHP 5.0 and MySQL,Kolkata"  />&nbsp;<label for="sc3>" onclick="showcoursedetails('getdetails');"> Programming with PHP 5.0 and MySQL</label><br /> 
		 		 
		 		 
		 		            <input type="radio" onclick="showcoursedetails('getdetails');" id="sc4" name="selectcourse"   value="4, Oracle 10 g PL/SQL Programming with Forms,Kolkata"  />&nbsp;<label for="sc4>" onclick="showcoursedetails('getdetails');"> Oracle 10 g PL/SQL Programming with Forms</label><br /> 
		 		 
		 		 
		 		            <input type="radio" onclick="showcoursedetails('getdetails');" id="sc5" name="selectcourse"   value="7, Networking ,Kolkata"  />&nbsp;<label for="sc5>" onclick="showcoursedetails('getdetails');"> Networking </label><br /> 
...
<div class="fl black" id="pp">
	...
	<p>Entire contents Copyright © 2013-2014 Globsyn Skills. All rights reserved.</p>
