...
<title>CCE | View Exam Name</title>
<sx:head/>
</head>
<body>
			    ...
			    <s:include value="../UserControler/LeftPanel.jsp"></s:include>
				 ...
				 <s:div cssClass="rightside">
						...
						<display:table id="viewDetails"    id="row" export="false"  requestURI="view.html"   name="sessionScope.viewDetails"  class="tablegrid" style="width:100%"    pagesize="10" >
								<display:column property="secondVal" title="Exam Name" sortable="true"/>
								<display:column property="thredVal" title="Exam type" sortable="true"/>
								<display:column property="fiveVal" title="Created On" sortable="true"/>
								<display:column property="fourthVal" title="Created By" sortable="true"/>								
								<display:column   title="Option"     sortable="false"  >																 	
        							<a href="edit.html?nameId=${row.firstVal}" onmouseover="window.status='false'">
        								<img src="../images/edit.png" alt="Edit" title="Edit"/>
        							</a> 
        							<a href="show.html?nameId=${row.firstVal}">
        								<img src="../images/view.png" alt="Delete" title="View"/>
        							</a>
        							<a href="delete.html?nameId=${row.firstVal}" >
