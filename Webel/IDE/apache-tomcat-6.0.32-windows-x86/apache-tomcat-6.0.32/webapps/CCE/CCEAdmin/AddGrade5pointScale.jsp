...
<title>CCE | <s:if test="(gradeId == null || gradeId.equals('') ||gradeId.equals('-1'))">Add</s:if><s:else>Edit</s:else> Grade (5 point scale)</title>
</head>
<body>
	   ...
	   <s:div cssClass="container">
		<s:div cssClass="container1">
			<s:div cssClass="wrapper">
			    ...
			    <s:hidden name="scale" value="5 point" ></s:hidden>
				</s:div>
				<s:div cssClass="rightside">
						<h1><s:if test="(gradeId == null || gradeId.equals('')||gradeId.equals('-1'))">Add</s:if><s:else>Edit</s:else> Grade(5 point scale)  </h1>
						<div class="form">
							<table >						
								<tr>
								...
								<tr class="even" >
									...
									<td><s:textfield name="txtupperMarks" id="txtupperMarks" required="true" key="upperMarks"  cssClass="textbox" onblur="extractNumber(this,2,true);" onkeyup="extractNumber(this,2,true);" onkeypress="return blockNonNumbers(this, event, true, true);" ></s:textfield></td>
								...
								<tr >
									...
									<td><s:fielderror  fieldName="grade" theme="simple" cssClass="error" /><s:hidden name="oddeven" id="oddeven" value="even"></s:hidden><input  value="Add" class="blue-button" style="width: 30px"  name="add" onclick="addNew()" /></td>
								</tr>																
								<tr valign="top">
...
function addNew(){
	...
	if(lowerMarks.value !='' && upperMarks.value !='' && grade.value !='' ){	
		...
		var oddeven=document.getElementById('oddeven');			
			if(oddeven.value =='even'){
				addId.innerHTML +="<tr class='even' align='left'>"+
									...
									"<td width='30%' align='center'>"+grade.value+"<input type='hidden' name='grade' value='"+grade.value+"'/></td>"+																	
								"</tr>";
				oddeven.value='odd';
			}
			...
			lowerMarks.value = parseInt(upperMarks.value)+0.1;
			upperMarks.value='';
			grade.value='';	
			gradePoint.value=''
		}	
