...
<title>CCE | View Scholastic Paper</title>
<sx:head/>
</head>
<body>
			    ...
			    <s:include value="../UserControler/LeftPanel.jsp"></s:include>
				 ...
				 <s:div cssClass="rightside">
						...
						<display:table id="viewDetails"    id="row" export="false"  requestURI="view.html"   name="sessionScope.viewDetails"  class="tablegrid" style="width:100%"    pagesize="10" >
								...
								<display:column property="secondVal" title="Subject" sortable="true"/>
								<display:column property="thredVal" title="Paper Name" sortable="true"/>
								<display:column property="fourthVal" title="Marks" sortable="true"/>
								...
								<display:column   title="Option"     sortable="false"  >																 	
        							<a href="edit.html?paperId=${row.firstVal}" onmouseover="window.status='false'">
        								<img src="../images/edit.png" alt="Edit" title="Edit"/>
        							</a> 
        							<a href="show.html?paperId=${row.firstVal}">
        								<img src="../images/view.png" alt="Delete" title="View"/>
        							</a>
        							<a href="delete.html?paperId=${row.firstVal}" >
