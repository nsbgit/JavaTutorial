...
<title>CCE | Scholastic Marks Report</title>
</head>
<body>
			...
			<s:div cssClass="wrapper">
				...
				<s:div cssClass="rightside">
						...
						<!-- 		<tr >
									...
									<td style="width: 35%"><sx:autocompleter    headerKey="" headerValue="Select" list="categoryList" id="category" listKey="firstVal" listValue="secondVal"    name="category" cssClass="combobox" onchange="getSelectText('categoryText','category');"></sx:autocompleter></td>
						 ...
						 -->			
								<tr class="even" >
									...
									<td><sx:autocompleter    headerKey="" headerValue="Select" list="academicYearList" id="academicYear"   name="academicYear" cssClass="combobox" onchange="loadNewValueFor2(document.getElementById('standard').value,this.value,'newSubject','subjectBind.html')"></sx:autocompleter></td>
									<td><s:fielderror  fieldName="academicYear" theme="simple" cssClass="error" /></td>
								</tr>							
								<tr  >
									<td >Standard<em>*</em> :</td>
									<td ><sx:autocompleter    headerKey="" headerValue="Select" list="standardList"  listKey="firstVal" listValue="secondVal" id="standard"    name="standard" cssClass="combobox" onchange="getSelectText('standardText','standard');loadNewValueFor2(this.value,document.getElementById('academicYear').value,'newSubject','subjectBind.html')" ></sx:autocompleter></td>
								...
								<tr >
									<td colspan="3">									
											<a href="#" id="m" onclick="redirect('1')"  class="thickbox" >        								
        										<input type="button" value="Marks Report"  class="blue-button " >    
        									</a> 
        									<a href="#" id="t" onclick="redirect('2')"  class="thickbox" >        								
        										<input type="button" value="Teacher Record Card"  class="blue-button " >    
        									</a>          									    										
...
<SCRIPT type="text/javascript">
	function redirect(urlT){		
		...
		var admissionNo=document.getElementById('admissionNo').value;		
			if( academicYear !='' && standard !='' && subject !='' && admissionNo !=''){
				if(urlT==1){
					var url="report.html?academicYear="+academicYear+"&standard="+standard+"&standardText="+standardText+"&subject="+subject+"&subjectText="+subjectText+"&admissionNo="+admissionNo+"&keepThis=true&TB_iframe=true&height=550&width=950";
					document.getElementById('m').href=	url	;
				}
				else{
					var url="trc.html?academicYear="+academicYear+"&standard="+standard+"&standardText="+standardText+"&subject="+subject+"&subjectText="+subjectText+"&admissionNo="+admissionNo+"&keepThis=true&TB_iframe=true&height=550&width=950";
