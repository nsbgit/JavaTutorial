							...
							<table >						
							 ...
							 -->		
								...
								<tr  class="even">
									...
									<td ><sx:autocompleter    headerKey="" headerValue="Select"  list="standardList"  listKey="firstVal" listValue="secondVal" id="standard" onchange="javascript:loadNewValue(this.value,'newArea','getArea.html');getSelectText('standardText','standard');"  name="standard" cssClass="combobox"  ></sx:autocompleter></td>
									<td ><s:fielderror  fieldName="standard" theme="simple" cssClass="error" /><s:hidden name="standardText" id="standardText" /></td>
								</tr>
								<tr >
									<td>Area<em>*</em> :</td>
									<td id="newArea"><sx:autocompleter    headerKey="" headerValue="Select" list="{}"  name="area" id="area" cssClass="combobox" onchange="getSelectText('areaText','area');javascript:loadNewValue(this.value,'newExamName','examNameBind.html')"></sx:autocompleter></td>
									<td ><s:fielderror  fieldName="subject" theme="simple" cssClass="error" /> <s:hidden name="areaText" id="areaText" /></td>
								</tr>	
								<tr class="even">
									<td>Sub Area<em>*</em> :</td>
									<td id="newSubArea"><sx:autocompleter    headerKey="" headerValue="Select"   name="subArea" id="subArea" cssClass="combobox" onchange="getSelectText('subAreaText','subArea');"></sx:autocompleter></td>
									<td><s:fielderror  fieldName="examType" theme="simple" cssClass="error" /><s:hidden name="subAreaText" id="subAreaText" /></td>
								</tr>									
								<tr>
									<td colspan="3">									
...
<SCRIPT type="text/javascript">
	function redirect(){		
		...
		var subAreaText	=document.getElementById('subAreaText').value;	
			if(academicYear !='' && standard !='' && area !='' && subArea !='' ){				
				document.getElementById('a').href="marksEntryForm.html?academicYear="+academicYear+"&standard="+standard+"&standardText="+standardText+"&area="+area+"&areaText="+areaText+"&subArea="+subArea+"&subAreaText="+subAreaText+"&keepThis=true&TB_iframe=true&height=550&width=950";						
				return true;
			}
			else
			{	
