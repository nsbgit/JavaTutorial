...
<title>CCE | View Health Status</title>
<sx:head/>
</head>
<body>
			...
			<s:div cssClass="wrapper">
			    <s:include value="../UserControler/LeftPanel.jsp"></s:include>
				 ...
				 <s:div cssClass="rightside">
						...
						<div class="grid">
						<sx:div theme="ajax">												
						<display:table id="viewDetails"    id="row" export="false"  requestURI="viewHealthStatus.html"   name="sessionScope.viewDetails"  class="tablegrid" style="width:100%"    pagesize="10" >
								<display:column property="secondVal" title="Name" sortable="true"/>
								<display:column property="sevenVal" title="Standard" sortable="true"/>
								<display:column property="thredVal" title="Height" sortable="true"/>
								<display:column property="fourthVal" title="Weight" sortable="true"/>
								...
								<display:column   title="Option"     sortable="false"  >																 	
        							<a href="editType.html?typeId=${row.firstVal}" onmouseover="window.status='false'">
