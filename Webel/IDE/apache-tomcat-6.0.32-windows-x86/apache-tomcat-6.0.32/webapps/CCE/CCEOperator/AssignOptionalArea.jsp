...
<title>CCE | Assign Optional Area</title>
</head>
<body>
...
<SCRIPT type="text/javascript">
	function redirect(){		
		var standard=document.getElementById('standard').value;		
			if(standard !=''){				
				document.getElementById('a').href="entryForm.html?standard="+standard+"&keepThis=true&TB_iframe=true&height=550&width=950";						
				return true;
			}
			else
			{	
