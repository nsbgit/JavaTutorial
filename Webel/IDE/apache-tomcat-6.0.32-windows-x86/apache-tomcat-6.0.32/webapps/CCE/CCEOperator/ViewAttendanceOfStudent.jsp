...
<title>&nbsp;&nbsp;&nbsp;&nbsp;CCE | View Attendance</title>
<sx:head/>
</head>
<body>
	...
	<s:div>
	 <s:div cssClass="main1" >    	
						...
						<display:table id="viewDetails"    id="row" export="false"  requestURI="view.html"   name="sessionScope.viewDetails"  class="tablegrid" style="width:100%"    pagesize="10" >
								<display:column property="secondVal" title="Student Name" sortable="true"/>								
								<display:column property="thredVal" title="Standard" sortable="true"/>
								<display:column property="fourthVal" title="Exam Type" sortable="true"/>
								<display:column property="fiveVal" title="Total Attendance" sortable="true"/>
