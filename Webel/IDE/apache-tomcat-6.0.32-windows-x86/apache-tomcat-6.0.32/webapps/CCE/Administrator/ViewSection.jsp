			...
			<s:div cssClass="wrapper">
			    <s:include value="../UserControler/LeftPanel.jsp"></s:include>
				 ...
				 <s:div cssClass="rightside">
						...
						<div class="grid">
						<sx:div theme="ajax">												
						<display:table id="viewDetails"    id="row" export="false"  requestURI="viewSection.html"   name="sessionScope.viewDetails"  class="tablegrid" style="width:100%"    pagesize="10" >
								<display:column property="secondVal" title="Section" sortable="true"/>
								...
								<display:column   title="Option"     sortable="false"  >																 	
        							<a href="edit.html?sectionId=${row.firstVal}" onmouseover="window.status='false'">
        								<img src="../images/edit.png" alt="Edit" title="Edit"/>
        							</a> 
        							<a href="show.html?sectionId=${row.firstVal}">
        								<img src="../images/view.png" alt="Delete" title="View"/>
        							</a>
        							<a href="delete.html?sectionId=${row.firstVal}" >
