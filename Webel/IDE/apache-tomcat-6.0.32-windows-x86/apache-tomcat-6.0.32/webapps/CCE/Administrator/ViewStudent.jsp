			    ...
			    <s:include value="../UserControler/LeftPanel.jsp"></s:include>
				 ...
				 <s:div cssClass="rightside">
						...
						<display:table id="viewDetails"    id="row" export="false"  requestURI="view.html"   name="sessionScope.viewDetails"  class="tablegrid" style="width:100%"    pagesize="10" >
								...
								<display:column property="fourthVal" title="Standard" sortable="true"/>
								<display:column property="thredVal" title="Admition No." sortable="true"/>
								...
								<display:column   title="Option"     sortable="false"  >																 	
        							<a href="edit.html?StudentId=${row.firstVal}" onmouseover="window.status='false'">
        								<img src="../images/edit.png" alt="Edit" title="Edit"/>
        							</a> 
        							<a href="show.html?StudentId=${row.firstVal}">
        								<img src="../images/view.png" alt="View" title="View"/>
        							</a>
        							<a href="delete.html?StudentId=${row.firstVal}" >
        								<img src="../images/delete.png" alt="Delete" title="Delete" onclick="return delConfirm()"/>
        							</a> 
        							<a href="familyEdit.html?StudentId=${row.firstVal}" >
        								<img src="../images/family-icon.png" alt="Delete" title="Family Edit" />
        							</a>  
        							<a href="familyView.html?StudentId=${row.firstVal}" >
        								<img src="../images/view.png" alt="Delete" title="Family View" />
        							</a>          							        							   																	 									 									 										 									 
								</display:column>																            								 										
					</display:table>
					<div>&nbsp;</div>
