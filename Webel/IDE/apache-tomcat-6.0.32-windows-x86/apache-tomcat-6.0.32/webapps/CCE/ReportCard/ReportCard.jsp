								...
								<tr class="even">
									<td colspan="3">																				
        									<a href="#" id="cm" onclick="redirect('3')" class="thickbox"  >        								
        										<input type="button" value="Get Report Card"  class="blue-button " >    
        									</a>           									        									 									         									    									
	...
	function redirect(urlT){		
		...
		var admissionNo=document.getElementById('admissionNo').value;		
			if(academicYear !='' && standard !=''  && admissionNo !=''){
				 if(urlT==3){
					var url="report.html?academicYear="+academicYear+"&standard="+standard+"&standardText="+standardText+"&admissionNo="+admissionNo+"&partNo=2A&keepThis=true&TB_iframe=true&height=550&width=850";
